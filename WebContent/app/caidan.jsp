				...
				<ul>
					...
					<c:forEach var="food" items="${requestScope.pb.pageData}">
						...
						<li>
							<dl>
								<dt>
									<a href="${pageContext.request.contextPath }/app/caixiangxi.jsp?foodImg=${food.img}&foodName=${food.foodName}&foodRemark=${food.remark}&foodPrice=${food.price}&foodId=${food.id}">
										<img width="214px" height="145px" src="${pageContext.request.contextPath }/app/foodImg/${food.img }" />
									</a>
								</dt>
								<dd class="f1">
									<a href="${pageContext.request.contextPath }/app/caixiangxi.jsp?foodImg=${food.img}&foodName=${food.foodName}&foodRemark=${food.remark}&foodPrice=${food.price}&foodId=${food.id}">${food.foodName }</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath }/app/caixiangxi.jsp?foodImg=${food.img}&foodName=${food.foodName}&foodRemark=${food.remark}&foodPrice=${food.price}&foodId=${food.id}">&yen;${food.price }</a>
								</dd>
							</dl>
						</li>
					</c:forEach>
