...
<head>
	...
	<script type="text/javascript">
		...
		function callPay(node) {
			...
			window.location.href = "${pageContext.request.contextPath }/foodTypeServlet?method=payFor";
		}
	</script>
</head>
				...
				<table align="center" width="100%">
					...
					<tr height="60">
							<td align="center" width="20%">${row.foodName }</td>
					 		<td align="center" width="20%">￥${row.foodPrice }</td>
					 		<td align="center" width="20%">${row.count }</td>
					 		<td align="center" width="20%">${row.count * row.foodPrice}</td>
