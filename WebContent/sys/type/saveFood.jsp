...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/sysFoodServlet?method=addFood" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
							...
							<td>
							  <select name="foodTypeId" id="foodTypeId" >
                           	 ...
                           	 * <input type="hidden" name="ild" class="InputStyle" value="1">
                             </td>
				   </tr>
						<tr>
							<td width="80px">菜名</td>
